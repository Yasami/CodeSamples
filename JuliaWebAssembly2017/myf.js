...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'myf.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'myf.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'myf.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "myf.html.mem" : null;
